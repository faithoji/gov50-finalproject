...
race_graph <- race_compiled|>
  ggplot(aes(x = year))+
  geom_line(aes(y= Black, colour = "deeppink1"))+
  geom_line(aes(y= White, colour = "deepskyblue1"))+
  geom_line(aes(y= Hispanic, colour = "darkorchid1"))+
